import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,b as e}from"./app-7728b332.js";const t={},p=e(`<h1 id="游标" tabindex="-1"><a class="header-anchor" href="#游标" aria-hidden="true">#</a> 游标</h1><h1 id="索引" tabindex="-1"><a class="header-anchor" href="#索引" aria-hidden="true">#</a> 索引</h1><p>​ 创建、删除、位图索引、组合索引<br> ​ create index index_name on table_name(table_column)</p><h1 id="触发器" tabindex="-1"><a class="header-anchor" href="#触发器" aria-hidden="true">#</a> 触发器</h1><p>​ 语句级触发器<br> ​ 行级触发器<br> ​ 触发器功能：<br> ​ 1.允许/限制对表的修改<br> ​ 2.自动生成派生列，比如自增字段<br> ​ 3.强制数据一致性<br> ​ 4.提供审计和日志记录<br> ​ 5.防止无效的事务处理<br> ​ 6.启用复杂的业务逻辑<br> ​ create or replace trigger tri_name<br> ​ [before | after | instead of] tri_event<br> ​ on table_name | view_name | user_name |db_name<br> ​ [ for each row] [when tri_condition]<br> ​ begin<br> ​ plsql_sentences;<br> ​ end tri_name;<br> ​</p><pre><code>		说明：
			:NEW 修饰符访问操作完成后列的值
			:OLD 修饰符访问操作完成前列的值
