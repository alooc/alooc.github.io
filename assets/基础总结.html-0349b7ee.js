import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{o as e,c as n,f as o}from"./app-a2c721dc.js";const r={},a=o(`<h1 id="第一章-java-ee应用" tabindex="-1"><a class="header-anchor" href="#第一章-java-ee应用" aria-hidden="true">#</a> 第一章 Java EE应用</h1><pre><code>## Java EE架构：
	Domain Object(领域对象层)
...
</code></pre><p>​ <br> Mapper XML映射文件：</p><pre><code>	常用的元素：
		select 映射查询语句
		insert 映射插入语句
		update 映射更新语句
		delete 映射删除语句
...
</code></pre><h1 id="第十章-深入使用mybatis" tabindex="-1"><a class="header-anchor" href="#第十章-深入使用mybatis" aria-hidden="true">#</a> 第十章 深入使用MyBatis</h1><pre><code>关联映射：
	一对一
	一对多
	多对多
...
</code></pre><p>​ <br> ​ <br> 关联：<br> =========================================================<br> select属性表示需要关联执行的SQL语句<br> fetchType表示查询类型是立即加载（EAGER）还是懒加载（LAZY） <br> 【区别：没用时加载，用到时再加载】<br> =========================================================</p><pre><code>	一对一关联：
		td_person td_card
...
</code></pre><p>​</p><hr><hr><hr><p>学生 班级<br> 一对一<br> 一对多<br> 多对多</p><p>​ <br> ​ <br> ​</p>`,34),s=[a];function u(i,l){return e(),n("div",null,s)}const c=t(r,[["render",u],["__file","基础总结.html.vue"]]);export{c as default};
