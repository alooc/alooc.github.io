import{_ as s,C as o,c as p,o as u,j as e,ag as g,a as n,G as a,w as l}from"./chunks/framework.DPDPlp3K.js";const f=JSON.parse('{"title":"JSP/Servlet及相关技术详解","description":"","frontmatter":{"title":"JSP/Servlet及相关技术详解","date":"2020-01-01T09:02:55.000Z","categories":["编程语言","Java"],"tags":["Java"]},"headers":[],"relativePath":"notes/basics/lang/java/JSP_Servlet笔记.md","filePath":"notes/basics/lang/java/JSP_Servlet笔记.md"}'),m={name:"notes/basics/lang/java/JSP_Servlet笔记.md"};function q(v,t,d,j,S,c){const r=o("welcome-file"),i=o("welcome-file-list");return u(),p("div",null,[t[13]||(t[13]=e("h1",{id:"_1-web-xml",tabindex:"-1"},[n("1.web.xml： "),e("a",{class:"header-anchor",href:"#_1-web-xml","aria-label":'Permalink to "1.web.xml："'},"​")],-1)),e("ul",null,[t[5]||(t[5]=e("li",null,"配置JSP",-1)),t[6]||(t[6]=e("li",null,"配置和管理Servlet",-1)),t[7]||(t[7]=e("li",null,"配置和管理Listener",-1)),t[8]||(t[8]=e("li",null,"配置和管理Filter",-1)),t[9]||(t[9]=e("li",null,"配置标签库",-1)),t[10]||(t[10]=e("li",null,"配置JSP属性",-1)),t[11]||(t[11]=e("li",null,"配置和管理JASS授权认证",-1)),t[12]||(t[12]=e("li",null,"配置和管理资源引用",-1)),e("li",null,[t[3]||(t[3]=n("Web应用的首页 ")),a(i,null,{default:l(()=>[a(r,null,{default:l(()=>t[0]||(t[0]=[n("index.html")])),_:1}),a(r,null,{default:l(()=>t[1]||(t[1]=[n("index.htm")])),_:1}),a(r,null,{default:l(()=>t[2]||(t[2]=[n("index.jsp")])),_:1})]),_:1}),t[4]||(t[4]=n(" metadata-complete:该属性接受true和false两个属性值。为true时，该web应用不会加载注解配置的web组件（如Servlet,Filter,Listener等）"))])]),t[14]||(t[14]=g(`<h1 id="_2-jsp的基本原理" tabindex="-1">2.JSP的基本原理： <a class="header-anchor" href="#_2-jsp的基本原理" aria-label="Permalink to &quot;2.JSP的基本原理：&quot;">​</a></h1><ul><li><p>jsp就是servlet</p></li><li><p>jsp页面组成：</p><ul><li>1.静态部分。标准html</li><li>2.动态部分。收Java程序控制的内容，这些内容由Java脚本动态生成。</li></ul></li></ul><h1 id="_3-jsp的4种基本语法" tabindex="-1">3.jsp的4种基本语法： <a class="header-anchor" href="#_3-jsp的4种基本语法" aria-label="Permalink to &quot;3.jsp的4种基本语法：&quot;">​</a></h1><ul><li><p>jsp注释： &lt;%--注释部分 --%&gt;</p></li><li><p>jsp声明： 用于声明变量和方法 &lt;%!声明部分%&gt;</p></li><li><p>jsp输出表达式： &lt;%=表达式%&gt;</p></li><li><p>jsp小脚本： &lt;% 代码 %&gt;</p></li></ul><h1 id="_4-jsp的3个编译指令" tabindex="-1">4.jsp的3个编译指令： <a class="header-anchor" href="#_4-jsp的3个编译指令" aria-label="Permalink to &quot;4.jsp的3个编译指令：&quot;">​</a></h1><ul><li><p>编译指令是通知servlet引擎的处理消息 &lt;%@ 编译指令名 属性名=“属性值” ...%&gt;</p></li><li><p>page指令： &lt;%@ page ...%&gt;</p><p>​ 定义页面需要的环境变量</p></li><li><p>include指令： &lt;%@ include file=&quot;relativeURLSpec&quot; %&gt; 包含并解析jsp</p></li><li><p>标签指令 &lt;%@ taglib uri=&quot;&quot; prefix=&quot;mytag&quot; %&gt;</p></li></ul><h1 id="_5-jsp的7个动作指令" tabindex="-1">5.jsp的7个动作指令： <a class="header-anchor" href="#_5-jsp的7个动作指令" aria-label="Permalink to &quot;5.jsp的7个动作指令：&quot;">​</a></h1><ul><li><p>动作指令是运行时的动作</p><pre><code>  jsp:forward
  ...
  jsp:getProperty
...
</code></pre></li></ul><h1 id="_6-jsp脚本中的9个内置对象" tabindex="-1">6.jsp脚本中的9个内置对象： <a class="header-anchor" href="#_6-jsp脚本中的9个内置对象" aria-label="Permalink to &quot;6.jsp脚本中的9个内置对象：&quot;">​</a></h1><pre><code>	这9个内置对象都是ServletAPI接口的实例，JSP规范对其进行默认的初始化。
	已经是对象了，可以直接使用。
...
</code></pre><h1 id="_7-servlet介绍" tabindex="-1">7.Servlet介绍： <a class="header-anchor" href="#_7-servlet介绍" aria-label="Permalink to &quot;7.Servlet介绍：&quot;">​</a></h1><pre><code>	1.Servlet的开发：
...
</code></pre><h1 id="_8-jsp2的自定义标签" tabindex="-1">8.JSP2的自定义标签： <a class="header-anchor" href="#_8-jsp2的自定义标签" aria-label="Permalink to &quot;8.JSP2的自定义标签：&quot;">​</a></h1><pre><code>	这种标签具有和html标签类似的语法，又可以完成JSP脚本的功能。
	...
	动态属性的标签
</code></pre><h1 id="_9-filter介绍" tabindex="-1">9.Filter介绍： <a class="header-anchor" href="#_9-filter介绍" aria-label="Permalink to &quot;9.Filter介绍：&quot;">​</a></h1><pre><code>	使用Filter的完整流程：
		Filter对用户请求进行预处理，接着将请求交给Servlet进行处理并生成响应，最后Filter再对服务器响应进行后处理。
	
	创建：
		1.创建Filter处理类
		2.web.xml中配置
</code></pre><h1 id="_10-listener介绍" tabindex="-1">10.Listener介绍： <a class="header-anchor" href="#_10-listener介绍" aria-label="Permalink to &quot;10.Listener介绍：&quot;">​</a></h1><p>步骤： 1.定义Listener实现类 2.通过注解或在web.xml文件中配置Listener</p><p>​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​ ​</p>`,19))])}const P=s(m,[["render",q]]);export{f as __pageData,P as default};
