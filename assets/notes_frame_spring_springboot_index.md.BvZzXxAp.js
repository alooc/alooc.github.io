import{_ as i,c as a,o as n,ag as t}from"./chunks/framework.DPDPlp3K.js";const d=JSON.parse('{"title":"SpringBoot基础总结","description":"","frontmatter":{"title":"SpringBoot基础总结","date":"2020-01-01T09:02:55.000Z","categories":["后端框架","SpringBoot"],"tags":"SpringBoot","sidebar":"heading"},"headers":[],"relativePath":"notes/frame/spring/springboot/index.md","filePath":"notes/frame/spring/springboot/index.md"}'),p={name:"notes/frame/spring/springboot/index.md"};function l(h,s,e,k,r,E){return n(),a("div",null,s[0]||(s[0]=[t(`<p>简介，简单项目配置：</p><p>application.yml</p><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">spring</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
...
&lt;/dependency&gt;
</code></pre><h1 id="源码分析" tabindex="-1">源码分析 <a class="header-anchor" href="#源码分析" aria-label="Permalink to &quot;源码分析&quot;">​</a></h1><ul><li><a href="/notes/frame/spring/springboot/source-analysis.html">源码分析</a></li></ul>`,38)]))}const o=i(p,[["render",l]]);export{d as __pageData,o as default};
