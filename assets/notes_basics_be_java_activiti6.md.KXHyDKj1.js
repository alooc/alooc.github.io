import{_ as n,c as a,o as t,ag as p}from"./chunks/framework.DPDPlp3K.js";const q=JSON.parse('{"title":"activiti6笔记","description":"","frontmatter":{"title":"activiti6笔记","date":"2020-01-01T09:02:55.000Z","categories":["后端技术","activiti"],"tags":["activiti","工作流"]},"headers":[],"relativePath":"notes/basics/be/java/activiti6.md","filePath":"notes/basics/be/java/activiti6.md"}'),e={name:"notes/basics/be/java/activiti6.md"};function l(i,s,c,o,r,u){return t(),a("div",null,s[0]||(s[0]=[p(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>first-demo：</span></span>
