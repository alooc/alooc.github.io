import{_ as n,c as a,o as t,ag as p}from"./chunks/framework.DPDPlp3K.js";const q=JSON.parse('{"title":"activiti6笔记","description":"","frontmatter":{"title":"activiti6笔记","date":"2020-01-01T09:02:55.000Z","categories":["后端技术","activiti"],"tags":["activiti","工作流"]},"headers":[],"relativePath":"notes/be/tech-stack/activiti/activiti6.md","filePath":"notes/be/tech-stack/activiti/activiti6.md"}'),e={name:"notes/be/tech-stack/activiti/activiti6.md"};function l(i,s,c,o,r,u){return t(),a("div",null,s[0]||(s[0]=[p(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>first-demo：</span></span>
...
<span class="line"><span>	会签</span></span></code></pre></div>`,1)]))}const d=n(e,[["render",l]]);export{q as __pageData,d as default};
