import{_ as s,c as a,o as p,ag as l}from"./chunks/framework.DPDPlp3K.js";const g=JSON.parse('{"title":"第一行代码笔记","description":"","frontmatter":{"title":"第一行代码笔记","date":"2020-01-01T09:02:55.000Z","categories":["后端技术","android"],"tags":["android"]},"headers":[],"relativePath":"notes/basics/be/java/android/index.md","filePath":"notes/basics/be/java/android/index.md"}'),e={name:"notes/basics/be/java/android/index.md"};function t(i,n,c,o,r,d){return p(),a("div",null,n[0]||(n[0]=[l(`<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>1.</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>	implementation &#39;com.google.code.gson:gson:2.8.6&#39;</span></span></code></pre></div>`,1)]))}const u=s(e,[["render",t]]);export{g as __pageData,u as default};
